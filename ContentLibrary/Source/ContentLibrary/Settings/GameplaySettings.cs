...
public static class GameplaySettings {
    ...
    private static class General {
        ...
        private class RequireAllPlayersInDiveBell() : BoolOption(
            SettingKeys.RequireAllPlayersInDiveBell,
            true,
        ...
        private class RequireDiveBellDoorClosed() : BoolOption(
            SettingKeys.RequireDiveBellDoorClosed,
            true,
    ...
    private static class Player {
        ...
        [Register]
        private class Gravity() : FloatOption(
            SettingKeys.Gravity,
            20.0f,
            "Gravity",
            0f,
    ...
    private static class Oxygen {
        ...
        private class OxygenUsageMultiplier() : FloatOption(
            SettingKeys.OxygenUsageMultiplier,
            1.0f,
        ...
        private class SprintMultiplier() : FloatOption(
            SettingKeys.SprintMultiplier,
            1.0f,
            "Sprinting Oxygen Usage Multiplier",
            1f,
            10f,
            false
        );
        ...
        private class RefillOxygenInDiveBell() : BoolOption(
            SettingKeys.RefillOxygenInDiveBell,
            false,
        ...
        private class UseOxygenOnSurface() : BoolOption(
            SettingKeys.UseOxygenOnSurface,
            false,
        ...
        private class RefillOxygenOnSurface() : BoolOption(
            SettingKeys.RefillOxygenOnSurface,
            true,
    ...
    private static class Customization {
        ...
        [Register]
        private class FaceMinFont() : FloatOption(
            SettingKeys.FaceMinFont,
            10.0f,
            "Minimum Face Font Size",
            0f,
            100f,
            false
        );
        ...
        [Register]
        private class FaceMaxFont() : FloatOption(
            SettingKeys.FaceMaxFont,
            40.0f,
            "Maximum Face Font Size",
            0f,
            100f,
            false
        );
        ...
        [Register]
        private class FaceCharLimit() : IntOption(
            SettingKeys.FaceCharLimit,
            128,
            "Face Character Limit",
            0,
            512,
            false
        );
